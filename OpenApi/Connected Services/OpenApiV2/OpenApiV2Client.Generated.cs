...
namespace OpenApi.OpenApiV2
{
    ...
    public partial class TransformerClient 
    {
        ...
        /// <summary>Transformer Ett Koordinat</summary>
        /// <returns>Successful Response</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<CoordResult> GetAsync(double x, double y, double? z, double? t, Epsg fra, Epsg til)
        {
        ...
        public async System.Threading.Tasks.Task<CoordResult> GetAsync(double x, double y, double? z, double? t, Epsg fra, Epsg til, System.Threading.CancellationToken cancellationToken)
        {
            if (x == null)
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            var result_ = default(CoordResult); 
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<CoordResult>(responseData_, _settings.Value);
                                return result_; 
                            } 
        ...
        /// <summary>Transformer Mange Koordinater</summary>
        /// <returns>Successful Response</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<CoordResult>> PostAsync(Epsg fra, Epsg til, System.Collections.Generic.IEnumerable<CoordParams> body)
        {
            return PostAsync(fra, til, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<CoordResult>> PostAsync(Epsg fra, Epsg til, System.Collections.Generic.IEnumerable<CoordParams> body, System.Threading.CancellationToken cancellationToken)
        {
            if (fra == null)
                throw new System.ArgumentNullException("fra");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false); 
                            var result_ = default(System.Collections.Generic.ICollection<CoordResult>); 
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.Generic.ICollection<CoordResult>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                        ...
                        return default(System.Collections.Generic.ICollection<CoordResult>);
                    }
                    finally
                    {
                        if (response_ != null)
    ...
    public partial class ProjeksjonerClient 
    {
        ...
        /// <returns>Successful Response</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<EpsgResult>> GetAsync(Cat? kategori, CoordinateSystem? system)
        {
            return GetAsync(kategori, system, System.Threading.CancellationToken.None);
        }
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<EpsgResult>> GetAsync(Cat? kategori, CoordinateSystem? system, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/projeksjoner?");
            if (kategori != null) 
            {
                urlBuilder_.Append("kategori=").Append(System.Uri.EscapeDataString(ConvertToString(kategori, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (system != null) 
            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false); 
                            var result_ = default(System.Collections.Generic.ICollection<EpsgResult>); 
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.Generic.ICollection<EpsgResult>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                        ...
                        return default(System.Collections.Generic.ICollection<EpsgResult>);
                    }
                    finally
                    {
                        if (response_ != null)
    ...
    public enum Cat
    {
        [System.Runtime.Serialization.EnumMember(Value = @"enkel")]
        Enkel = 0,
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.13.22.0 (Newtonsoft.Json v12.0.0.2)")]
    public partial class CoordParams 
    {
        /// <summary>Lengdegrad / øst / X</summary>
        [Newtonsoft.Json.JsonProperty("x", Required = Newtonsoft.Json.Required.Always)]
        public double X { get; set; }
    
        /// <summary>Breddegrad / nord / Y</summary>
        [Newtonsoft.Json.JsonProperty("y", Required = Newtonsoft.Json.Required.Always)]
        public double Y { get; set; }
    
        /// <summary>Høyde / Z</summary>
        ...
        public static CoordParams FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CoordParams>(data);
        }
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.13.22.0 (Newtonsoft.Json v12.0.0.2)")]
    public partial class CoordResult 
    {
        /// <summary>Lengdegrad / øst / X</summary>
        [Newtonsoft.Json.JsonProperty("x", Required = Newtonsoft.Json.Required.Always)]
        public double X { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.13.22.0 (Newtonsoft.Json v12.0.0.2)")]
    public partial class EpsgResult 
    {
        ...
        public static EpsgResult FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<EpsgResult>(data);
        }
    ...
    public enum CoordinateSystem
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"ED50")]
        ED50 = 1,
    
        [System.Runtime.Serialization.EnumMember(Value = @"ETRS89")]
        ETRS89 = 2,
    
        [System.Runtime.Serialization.EnumMember(Value = @"ITRF2014")]
        ITRF2014 = 3,
    
        [System.Runtime.Serialization.EnumMember(Value = @"NGO48")]
        NGO48 = 4,
    
        [System.Runtime.Serialization.EnumMember(Value = @"NN54")]
        NN54 = 5,
    
        [System.Runtime.Serialization.EnumMember(Value = @"NN2000")]
        NN2000 = 6,
    ...
    public partial class ValidationError 
    {
        ...
        public System.Collections.Generic.ICollection<Anonymous> Loc { get; set; } = new System.Collections.ObjectModel.Collection<Anonymous>();
